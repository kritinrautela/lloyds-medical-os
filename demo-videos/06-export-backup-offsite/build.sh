...
"$FFMPEG" -y -i raw.webm -i narration.aiff -filter_complex "[0:v]setpts=PTS/1.0000,tpad=stop_mode=clone:stop_duration=1.904,subtitles='/Users/kritin/LLOYDS SERVER /demo-videos/06-export-backup-offsite/subtitles.srt':force_style='FontName=Helvetica,FontSize=9,Bold=1,PrimaryColour=&H00FFFFFF,OutlineColour=&HC0000000,BackColour=&H90000000,BorderStyle=4,Outline=1,Shadow=0,MarginV=14'[v]" -map "[v]" -map 1:a -c:v libx264 -preset medium -crf 20 -pix_fmt yuv420p -c:a aac -b:a 128k -movflags +faststart final.mp4
